        ...
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
          {OFFRES.map((offre, idx) => (
            <div
              ...
              className="group relative flex flex-col gap-8 rounded-3xl border border-white/10 bg-white/[0.01] px-8 py-12 text-left backdrop-blur-xl transition-all duration-500 hover:bg-white/[0.03] active:scale-95"
              style={{
