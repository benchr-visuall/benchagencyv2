  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center text-center">
        ...
        {/* Title */}
        <h2
          className="mb-12 text-5xl leading-[0.9] font-black tracking-tighter uppercase md:text-7xl lg:text-9xl"
        ...
        <div className="mx-auto mb-24 flex w-full max-w-4xl flex-col items-center gap-8 px-4 text-center">
          <p
        ...
        <div className="grid w-full grid-cols-1 gap-12 border-t border-black/10 pt-16 md:grid-cols-3">
          {guarantees.map((item) => (
            <div
              key={item.label}
              className="group flex flex-col items-center gap-4 text-center transition-transform duration-300 hover:-translate-y-2"
            >
              <span
